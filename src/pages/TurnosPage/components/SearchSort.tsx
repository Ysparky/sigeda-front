          ...
          <div className="relative w-full sm:max-w-md">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pl-10 pr-4 rounded-md border border-gray-300 
        ...
        <div className="pt-2 border-t border-gray-100 mt-2">
          <p className="text-sm text-gray-600">
            {totalResults === 0 ? (
              ...
              <>
                Se encontraron{" "}
                <span className="font-medium">{totalResults}</span> turnos
                {searchTerm && (
                  <>
                    {" "}
              ...
              <>
                Mostrando <span className="font-medium">{totalResults}</span>{" "}
                turnos
              </>
            )}
          </p>
