...
export function SeleccionarGruposModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-[1000] p-4">
      <div className="bg-white rounded-lg w-full max-w-5xl p-8 relative animate-fade-in shadow-xl">
        <button
          onClick={onClose}
          ...
          <p className="text-sm text-gray-500">
            {!isAcceptEnabled && grupos.some((g) => g.selected) && (
              <span className="text-red-500 flex items-center">
                ...
                Complete el campo Instructor para todos los grupos seleccionados
              </span>
            )}
          </p>
